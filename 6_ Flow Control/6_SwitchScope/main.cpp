...
int main()
{
    ...
    case 0 :
        ...
        x = 6;
        x++;
        //z = 6;        // compile error: we cannot use this variable before declairing it
        std::cout << "x : " << x << std::endl;
        std::cout << "Statement1" << std::endl;
        std::cout << "Statement2" << std::endl;

/*                  if we do this "y" is not going to be known by other cases
                    {} changes the scope of variablesto be known just for case 0
        {
            int y;
            x = 6;
            x++;
